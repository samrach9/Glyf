...
"""
def NewStory(story, new_row):     # the story should be a string and new_row is a list of strings with the values for the columns in order
    new_row.insert(0, story) # Add story to beginning of database
...
# Testing
# story = "Jack and Jill went up the hill To fetch a pail of water; Jack fell down and broke his crown, And Jill came tumbling after."
# new_data = [1777, "Hike", "Death", "The Netherlands"]
    
# NewStory(story, new_data)
# UpdateLikeCount(0)
